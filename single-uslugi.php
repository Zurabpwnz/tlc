...
<?php if ( have_rows( 'logistika_-_varianty_dostavki' ) ): ?>
    ...
    <section class="delivery">
        <h2 class="title"><?php get_field( 'logistika_-_varianty_dostavki_-_zagolovok' ); ?></h2>
...
<?php get_template_part( 'template-parts/sections/banner-delivery-nomb' ); ?>
    ...
    <section class="info-block">
        ...
        <div class="info-block__content info-block__content-full">
            <?php the_field( 'informacziya_o_logistike_-_dop_opisanie' ); ?></div>
    </section>
