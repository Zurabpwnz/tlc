...
<head>
    ...
    <noscript><div><img src="https://mc.yandex.ru/watch/53134495" style="position:absolute; left:-9999px;" alt="" /></div></noscript>
    <!-- /Yandex.Metrika counter -->
    ...
    <div class="header__content">
        <div class="header__top">
            ...
            <div class="header-currency">
				...
				$CNY = $data["Valute"]["CNY"]["Value"]; // Получаем стоимость доллара
				//				echo "Доллар в рублях: $USD"; // Выводим на экран
				//				echo "CNY в рублях: $CNY"; // Выводим на экран
